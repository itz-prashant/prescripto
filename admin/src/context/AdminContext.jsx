...
const AdminContextProvider = (props) =>{
    ...
    const value = {
        aToken, setAToken, backendUrl, doctors, getAllDoctors, changeAvailablity, getAllAppointments,setAppointments,appointments, cancelAppointment, getDashData, dashData
    }
